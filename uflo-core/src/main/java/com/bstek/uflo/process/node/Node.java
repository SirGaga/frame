...
public abstract class Node implements java.io.Serializable{
	...
	private String eventHandlerBeanDesc;
	...
	protected String leaveNode(Context context,ProcessInstance processInstance,String flowName){
		...
		throw new IllegalArgumentException("不能执行所有顺序流程!");
	}
	...
	public String getEventHandlerBeanDesc() {
		return eventHandlerBeanDesc;
	}

	public void setEventHandlerBeanDesc(String eventHandlerBeanDesc) {
		this.eventHandlerBeanDesc = eventHandlerBeanDesc;
	}
