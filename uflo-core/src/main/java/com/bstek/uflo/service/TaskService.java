...
public interface TaskService {
	 ...
	 * @return 节点名称列表
	 */
	List<String> getAppointAssigneeTaskNodes(long taskId);
	...
	void setTaskVariable(Map<String,Object> variables,Long taskId);

	void setNextAssignee(String assignee,Long taskId);
}
